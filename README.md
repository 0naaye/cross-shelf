...
### 1. 함께대출 네트워크에서 추출한 융합형 테마 서가

![함께대출 네트워크에서 추출한 융합형 테마 서가](./outputs/network_overview.png)

### 2. 「아이와 함께 자라는 부모의 서가」 상세

![아이와 함께 자라는 부모의 서가 상세](./outputs/parent_shelf_detail.png)
...
📄 **[2026 도서관 데이터 활용 공모전 최종 제안서](./docs/proposal.pdf)**
